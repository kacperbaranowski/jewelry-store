		...
		<footer className='bg-primary text-white mt-auto'>
			<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16'>
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12'>
					...
					<div className='lg:col-span-1'>
						...
						<p className='mt-4 text-sm text-white/70 leading-relaxed'>
							Ekskluzywna biżuteria dla wyjątkowych chwil. Od 1998 roku tworzymy niepowtarzalne dzieła jubilerskie.
						</p>
					</div>
				...
				<div className='mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4'>
					<p className='text-sm text-white/50'>© {new Date().getFullYear()} Aurelius. Wszelkie prawa zastrzeżone.</p>
					...
					<div className='flex gap-6'>
						<a href='#' className='text-white/50 hover:text-accent' aria-label='Facebook'>
							<svg
								xmlns='http://www.w3.org/2000/svg'
								width='20'
								height='20'
						...
						<a href='#' className='text-white/50 hover:text-accent' aria-label='Instagram'>
							<svg
								xmlns='http://www.w3.org/2000/svg'
								width='20'
								height='20'
						...
						<a href='#' className='text-white/50 hover:text-accent' aria-label='Pinterest'>
							<svg
								xmlns='http://www.w3.org/2000/svg'
								width='20'
								height='20'
